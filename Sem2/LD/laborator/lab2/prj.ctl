...
set_global_assignment -name VERILOG_FILE majority.v
set_global_assignment -name SDC_FILE example1.sdc

set_global_assignment -name TOP_LEVEL_ENTITY parity
set_location_assignment -to clk PIN_AH10

set_location_assignment PIN_C10 -to c   ;# SW[2]
set_location_assignment PIN_C11 -to b  ;# LED[1]
set_location_assignment PIN_D12 -to a   ;# SW[0]
