...
set_location_assignment PIN_F15 -to c[3]   ;
set_location_assignment PIN_B14 -to c[2]   ;
set_location_assignment PIN_A14 -to c[1]   ;
set_location_assignment PIN_A13 -to c[0]   ;
